 ...
 */
final class Version20230515062611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation_status_event (id INT AUTO_INCREMENT NOT NULL, reservation_id INT DEFAULT NULL, reservation_status_catalog_id INT DEFAULT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_AEE52A55B83297E7 (reservation_id), INDEX IDX_AEE52A552E03D681 (reservation_status_catalog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
